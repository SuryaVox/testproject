...
class __Mustache_d7b4ccc822b9abf37a0eeb7587ec25b6 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <button class="navbar-toggler aabtn d-block d-md-none px-1 my-1 border-0" data-toggler="drawers" data-action="toggle" data-target="theme_iomadboost-drawers-primary">
';
...
';
        ...
        $buffer .= $this->section47f9e330f4fe6d5225aba4fe79bf21d1($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_iomadboost/primary-drawer-mobile')) {
...
';
    ...
    private function section47f9e330f4fe6d5225aba4fe79bf21d1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            {{> theme_iomadboost/language_menu }}
            <div class="divider border-left h-75 align-self-center mx-1"></div>
        ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
            ...
            foreach ($values as $value) {
                ...
                if ($partial = $this->mustache->loadPartial('theme_iomadboost/language_menu')) {
                    $buffer .= $partial->renderInternal($context, $indent . '            ');
                }
                $buffer .= $indent . '            <div class="divider border-left h-75 align-self-center mx-1"></div>
';
