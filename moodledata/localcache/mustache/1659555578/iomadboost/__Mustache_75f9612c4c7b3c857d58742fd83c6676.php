...
class __Mustache_75f9612c4c7b3c857d58742fd83c6676 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6d81a6e6e5d54d2a6b54160147f511e1($context, $indent, $value);
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->section8fd8cbbf3888f10194e25d37b0d4298a($context, $indent, $value);
...
';
        // 'courseindex' section
        $value = $context->find('courseindex');
        $buffer .= $this->sectionA3451be74da2dfa09c7d7759e7cc5da9($context, $indent, $value);
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->section52dfeccc74fecd71657ee2ef1334bdf8($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            ';
...
';
        ...
        $buffer .= $this->sectionA26030a6326a946d7d5dee734f0cf0b8($context, $indent, $value);
    ...
    private function section6d81a6e6e5d54d2a6b54160147f511e1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        {{< theme_iomadboost/drawer }}
            {{$id}}theme_iomadboost-drawers-courseindex{{/id}}
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        ';
                if ($parent = $this->mustache->loadPartial('theme_iomadboost/drawer')) {
                    $context->pushBlockContext(array(
                        'id' => array($this, 'blockB8dbf3c711d35c1fda262e7acc2fb65b'),
    ...
    private function section8fd8cbbf3888f10194e25d37b0d4298a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
        {{< theme_iomadboost/drawer }}
            {{$id}}theme_iomadboost-drawers-blocks{{/id}}
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_iomadboost/drawer')) {
                    $context->pushBlockContext(array(
                        'id' => array($this, 'block34599e1edfb8e6e30f1f745302a552a0'),
    ...
    private function sectionA3451be74da2dfa09c7d7759e7cc5da9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="drawer-toggler drawer-left-toggle open-nav d-print-none">
                        <button
                            ...
                            data-action="toggle"
                            data-target="theme_iomadboost-drawers-courseindex"
                            data-toggle="tooltip"
...
';
                $buffer .= $indent . '                            data-target="theme_iomadboost-drawers-courseindex"
';
...
';
    ...
    private function section52dfeccc74fecd71657ee2ef1334bdf8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="drawer-toggler drawer-right-toggle ml-auto d-print-none">
                        <button
                            ...
                            data-toggler="drawers"
                            data-action="toggle"
                            data-target="theme_iomadboost-drawers-blocks"
                            data-toggle="tooltip"
                            data-placement="right"
...
';
                $buffer .= $indent . '                            data-action="toggle"
';
                $buffer .= $indent . '                            data-target="theme_iomadboost-drawers-blocks"
';
                $buffer .= $indent . '                            data-toggle="tooltip"
';
                $buffer .= $indent . '                            data-placement="right"
...
';
    ...
    private function sectionA26030a6326a946d7d5dee734f0cf0b8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
require([\'theme_iomadboost/loader\', \'theme_iomadboost/drawer\'], function(Loader, Drawer) {
    Drawer.init();
...
';
                $buffer .= $indent . 'require([\'theme_iomadboost/loader\', \'theme_iomadboost/drawer\'], function(Loader, Drawer) {
';
...
';
    ...
    public function blockB8dbf3c711d35c1fda262e7acc2fb65b($context)
    {
        $indent = $buffer = '';
        $buffer .= 'theme_iomadboost-drawers-courseindex';
...
';
    ...
    public function block34599e1edfb8e6e30f1f745302a552a0($context)
    {
        $indent = $buffer = '';
        $buffer .= 'theme_iomadboost-drawers-blocks';
